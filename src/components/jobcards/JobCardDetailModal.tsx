  ...
  const handleSaveInspection = (e: React.FormEvent) => {
    ...
    const updated: JobCard = {
      ...
      vehicle: {
        ...
        vinNumber: editVin,
        chassisNumber: editVin,
        engineNumber: editEngineNo,
                ...
                <div className="flex items-center justify-between pb-2 border-b border-slate-200">
                  ...
                  {!isLocked && (
                    ...
                    >
                      ...
                      <span>{isEditingInspection ? 'Cancel Edit' : 'Edit Specs'}</span>
                    </button>
                  )}
                </div>

                {isEditingInspection && !isLocked ? (
                  <form onSubmit={handleSaveInspection} className="space-y-3 bg-white p-3 rounded-lg border border-slate-200">
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                      <div>
                        <label className="block text-[10px] font-bold text-slate-600 mb-1">Arrival Date</label>
                        <input
                          type="date"
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-600 mb-1">Entry Time</label>
                        <input
                          type="text"
                          value={editEntryTime}
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-600 mb-1">Odometer KM</label>
                        <input
                          type="number"
                          value={editOdo}
                          onChange={e => setEditOdo(parseInt(e.target.value) || 0)}
                          className="w-full border border-slate-300 rounded px-2 py-1 outline-none font-mono"
                          required
                        />
                      </div>
                      <div>
                        <label className="block text-[10px] font-bold text-slate-600 mb-1">VIN / Chassis Number</label>
                        <input
                          type="text"
                          value={editVin}
                          onChange={e => setEditVin(e.target.value.toUpperCase())}
                          className="w-full border border-slate-300 rounded px-2 py-1 outline-none font-mono uppercase"
                          required
                        />
                      </div>
                      <div>
                        <label className="block text-[10px] font-bold text-slate-600 mb-1">Engine Number</label>
                        <input
                          type="text"
                          value={editEngineNo}
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-600 mb-1">Fuel Level (%)</label>
                        <input
                          type="number"
                          min="0"
                          max="100"
                    ...
                    <div>
                      <label className="block text-[10px] font-bold text-slate-600 mb-1">Customer Reported Complaints / Scope</label>
                      <textarea
                        rows={2}
                        value={editRemarks}
                    ...
                    <div className="flex justify-end space-x-2 pt-1">
                      ...
                      <button
                        type="submit"
                        className="px-3 py-1 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg flex items-center space-x-1"
                      >
